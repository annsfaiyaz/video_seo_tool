"""
Django settings for video_seo_tool project.
...
SECRET_KEY = 'django-insecure-&2jpvpw#g6*$03vmmp$s&tpjwjfr3b$n@u%dd!re2^+6ihhdi*'
...
CRONJOBS = [
    ...
    ('* */24 * * *', 'myapp.cron.fetch_api_data'),  # Runs every 24 minutes
]